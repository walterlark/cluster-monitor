...
if [ $# == 1 ]; then
	...
	# enable the server
	curl -s "http://lb.walterblaurock.com/balancer-manager/?lf=1&ls=0&wr=$1&rr=&dw=&w=http%3A%2F%2F$1.walterblaurock.com&b=mycluster&nonce=9e162345-74ee-4f99-b077-5644c1708710" > /dev/null
